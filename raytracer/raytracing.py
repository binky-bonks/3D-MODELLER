...
class sphere:
   def __init__(self, centre, radius, color, specular):
      self.centre = centre
      self.radius = radius
      self.color = color
...
def main():
   ...
   for cx in range(-canvas_width//2, canvas_width//2):
      for cy in range(-canvas_height//2, canvas_height//2):
         ...
         color = trace_ray(camera_origin, direction, t_max = float("inf"), t_min = (1.0))
...
scene_spheres = [
   sphere(centre=vector(0,-5001,0), radius=5000, color=(255,255,0), specular=1000),
   sphere(centre=vector(0, -1, 3), radius=1, color=(255,0,0), specular=500),
   sphere(centre=vector(2, 0, 4), radius=1, color=(0,0,255), specular=500),
   sphere(centre=vector(-2,0,4), radius=1, color=(0,255,0), specular = 10)
]
...
def trace_ray(origin, direction, t_max, t_min):
